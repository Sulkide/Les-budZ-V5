...
public class PlayerData : ScriptableObject
{
	...
	[Header("Long Jump")]
	public float longJumpSpeed = 12f;
	public float longJumpVelocity = 12f;
	public float longJumpMaxHeight = 15f;
	[Range(0.01f, 0.5f)] public float longJumpInputTolerance = 0.12f;
